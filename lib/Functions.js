...
export default class Functions {
  ...
  async references({ file, line, character }) {
    this.#validateSchema('references', arguments[0])
  ...
  #validateSchema(method, parameters) {
  ...
  async definition({ file, line, character }) {
    this.#validateSchema('definition', arguments[0])
  ...
  async applyWorkspaceEdit(changes) {
    this.#validateSchema('applyWorkspaceEdit', changes)
